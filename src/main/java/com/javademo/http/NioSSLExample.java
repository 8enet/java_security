    ...
    public static void main(String[] args) throws Exception {
        ...
        final NioSSLProvider ssl = new NioSSLProvider(key, engine, ioBufferSize, ioWorker, taskWorkers) {
            ...
            public void onSuccess() {
                ...
                http.append("User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/48.0.2564.109 Safari/537.36\r\n");
                http.append("Connection: close\r\n");
                http.append("Host: www.baidu.com\r\n");
                http.append("\r\n");
